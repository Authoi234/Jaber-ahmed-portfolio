...
const Resume = () => {
    return (
        <div id='resume' className='mt-52 mb-40'>
            <div className='text-start ml-3 pl-6 mt-5'>
                ...
                <div className='mt-6' data-aos="fade-down-left">
                    <ul className="steps steps-vertical group">
                        <li data-content="" className="py-10 step step-neutral my-3 hover:text-green-400 hover:step-primary transition-all mt-10"><div>
                            <div>
                                <p className='text-lg pb-3 text-start'>2024 - Present</p>
                                <h2 className='text-3xl text-white text-start'>Ethical Hacker & Developer</h2>
                                <h5 className=' text-gray-400 text-sm text-start'>Brunodee Agency</h5>
                                <h2 className='text-3xl text-white pt-5 text-start'>Front-End Full Stack Web Developer</h2>
                                <h5 className=" text-gray-400 text-sm  text-start">Envato Market</h5>
                            </div>
                        </div></li>
                        <li data-content="" className="step step-neutral my-3 hover:text-green-400 hover:step-accent transition-all"><div>
                            <div>
                                ...
                                <h2 className='text-3xl text-white pt-5 text-start'>Web Designer</h2>
                                <h5 className=" text-gray-400 text-sm  text-start">Freelance</h5>
