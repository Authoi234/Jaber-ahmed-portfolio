    ...
    return (
        <div id='services' className='mt-40 mb-40'>
            <div className='text-start ml-3 pl-6 mt-5'>
                ...
                <div className="pl-6 my-5 card card-side bg-base-100 w-11/12 shadow-xl transition-all border-gray-400 border-2 hover:border-green-400 group">
                    <div className="flex justify-between items-center p-8">
                        ...
                        <div className='lg:ml-40'>
                            <FaBezierCurve className='text-green-400 text-4xl'></FaBezierCurve>
                        </div>
                    </div>
                </div>
                <div className="pl-6 my-5 card card-side bg-base-100 w-11/12 shadow-xl transition-all border-gray-400 border-2 hover:border-green-400 group">
                    <div className="flex justify-between items-center p-8">
                        ...
                        <div className='lg:ml-40'>
                            <FaCode className='text-green-400 text-4xl'></FaCode>
                        </div>
                    </div>
                </div>
                <div className="pl-6 my-5 card card-side bg-base-100 w-11/12 shadow-xl transition-all border-gray-400 border-2 hover:border-green-400 group">
                    <div className="flex justify-between items-center p-8">
                        ...
                        <div className='lg:ml-40'>
                            <IoIosGlobe className='text-green-400 text-4xl'></IoIosGlobe>
                        </div>
                    </div>
                </div>
                <div className="pl-6 my-5 card card-side bg-base-100 w-11/12 shadow-xl transition-all border-gray-400 border-2 hover:border-green-400 group">
                    <div className="flex justify-between items-center p-8">
                        ...
                        <div className='lg:ml-40'>
                            <FaLaptopCode className='text-green-400 text-4xl'></FaLaptopCode>
                        </div>
                    </div>
                </div>
            </div>
